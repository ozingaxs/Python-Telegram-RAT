...
@bot.message_handler(content_types=['document', 'audio', 'video', 'voice']) # list relevant content types
def addfile(message):
    command = message.text
...
@bot.message_handler(content_types=['photo']) # list relevant content types
def addfile(message):
